...
library(tidyverse) 
renew_use_2023 <- read_csv("./data/ev-power-mollyurfalian/renew-use-2023.csv")
renew_use_2022 <- read_csv("./data/ev-power-mollyurfalian/renew-use-2022.csv")
renew_use_2021 <- read_csv("./data/ev-power-mollyurfalian/renew-use-2021.csv")
...
```{r}
renew_use_2021 |> 
  str_detect(Energy_Source, "Wind|Hydro")
```
